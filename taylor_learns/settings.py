"""
Django settings for Taylor Learns project.
...
ROOT_URLCONF = "taylor_learns.urls"
...
WSGI_APPLICATION = "taylor_learns.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="taylor_learns"),
...
THEME_COOKIE_DOMAIN = env("THEME_COOKIE_DOMAIN", default=None)
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "taylor_learns_language"
...
SERVER_EMAIL = env("SERVER_EMAIL", default="noreply@taylorlearns.com")
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="taylor@bluestem.solutions")
...
EMAIL_SUBJECT_PREFIX = "[Taylor Learns] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Taylor Learns",
    "DESCRIPTION": "The personal blog and portfolio of Taylor Schaack",  # noqa: E501
    "VERSION": "0.1.0",
...
ASGI_APPLICATION = "taylor_learns.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
ADMINS = [("Taylor Schaack", "taylor@bluestem.solutions")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "taylor_learns": {
            "handlers": ["console"],
            "level": env("TAYLOR_LEARNS_LOG_LEVEL", default="INFO"),
        },
        "pegasus": {
            "handlers": ["console"],
